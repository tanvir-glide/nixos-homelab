# NixOS Configuration
Recently switched to NixOS for my server as it automates a lot of things I would have to rather change manually. It is even better than ansible imo.
...
* 
**Media Server:** Navidrome active on port 4533, serving music from /mnt/Files/Music.
...
* 
**Reverse Path:** Check set to loose to accommodate specific network configurations.# NixOS_server
